...
\begin{document}
\title{\textbf{Documento de especificación de requisitos Software}}
\maketitle
\author{\center{Jesús Aguirre Pemán \\ Enrique Ballesteros Horcajo \\ Jaime Dan Porras Rhee \\ Ignacio Iker Prado Rujas \\ \hspace{5.35 true cm} Alejandro Villarín Prieto }}
\newpage
\mbox{}
\thispagestyle{empty}
\newpage
