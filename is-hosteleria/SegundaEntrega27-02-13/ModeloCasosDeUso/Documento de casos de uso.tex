...
%EDITAR CLIENTE
	...
	\item \textbf{Editar cliente} 	%Esta es la plantilla para la descripción de un caso de uso expandido (que es importante y requiere detalle)		
			\begin{itemize}
...
%DAR DE BAJA CLIENTE
	\newpage
	\item \textbf{Dar de baja cliente} 	%Esta es la plantilla para la descripción de un caso de uso expandido (que es importante y requiere detalle)		
			\begin{itemize}
			\item \textbf{Actor:} Jefe, recepcionista.
